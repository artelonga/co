...
fn test_validate_all_valid_files() {
    ...
    // Create en/ context with valid content
    let en_path = tmp.path().join("en");
    std::fs::create_dir_all(en_path.join("tasks")).unwrap();
    std::fs::write(
        en_path.join("tasks/task1.md"),
...
fn test_validate_missing_language_error() {
    ...
    // Create en/ context with task missing language
    let en_path = tmp.path().join("en");
    std::fs::create_dir_all(en_path.join("tasks")).unwrap();
    std::fs::write(
...
fn test_validate_unknown_language_error() {
    ...
    // Create en/ context with task having nonexistent language
    let en_path = tmp.path().join("en");
    std::fs::create_dir_all(en_path.join("tasks")).unwrap();
    std::fs::write(
        en_path.join("tasks/task1.md"),
...
fn test_validate_unknown_scope_error() {
    ...
    // Create en/ context with task having nonexistent scope
    let en_path = tmp.path().join("en");
    std::fs::create_dir_all(en_path.join("tasks")).unwrap();
    std::fs::write(
        en_path.join("tasks/task1.md"),
...
fn test_validate_broken_link_warning() {
    ...
    // Create en/ context with task referencing nonexistent item
    let en_path = tmp.path().join("en");
    std::fs::create_dir_all(en_path.join("tasks")).unwrap();
    std::fs::write(
        en_path.join("tasks/task1.md"),
...
fn test_validate_item_specific() {
    ...
    // Create en/ context with a valid task
    let en_path = tmp.path().join("en");
    std::fs::create_dir_all(en_path.join("tasks")).unwrap();
    std::fs::write(
        en_path.join("tasks/my-task.md"),
...
fn test_validate_unknown_type_warning() {
    ...
    // Create en/ context with content having unknown type
    let en_path = tmp.path().join("en");

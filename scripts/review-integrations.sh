...
hr "1/6  topology — comunicacao meaning-topology as a tool (deterministic, offline PPMI)"
...
hr "6/6  ui-web-awesome — framework-agnostic web components (frontend path, NOT a CO-503 tool)"

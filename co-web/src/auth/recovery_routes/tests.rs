...
// All co-web tests MUST share "test-jwt-secret" (CO-295) to avoid JWT_SECRET races.
fn isolate_env() {
    unsafe {
...
fn build_test_router(dir: &std::path::Path) -> axum::Router {
    ...
    let state: AppState = crate::server::AppState::new(crate::server::AppStateInner {
...
fn test_return_to_safelist() {
    ...
    assert!(is_allowed_return_to("https://sub.artelonga.com.br"));

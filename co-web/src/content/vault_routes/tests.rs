...
fn test_code_file_mime_known_extensions() {
    assert_eq!(super::code_file_mime("script.py"), "text/x-python");
    assert_eq!(super::code_file_mime("main.rs"), "text/x-rust");
    assert_eq!(super::code_file_mime("app.ts"), "application/typescript");
    assert_eq!(super::code_file_mime("app.js"), "application/javascript");
    assert_eq!(super::code_file_mime("run.sh"), "text/x-shellscript");
    assert_eq!(super::code_file_mime("query.sql"), "text/x-sql");
    assert_eq!(super::code_file_mime("main.go"), "text/x-go");
    assert_eq!(super::code_file_mime("data.csv"), "text/csv");
    assert_eq!(
        super::code_file_mime("data.tsv"),
        "text/tab-separated-values"
    );
    assert_eq!(super::code_file_mime("page.html"), "text/html");
    assert_eq!(super::code_file_mime("style.css"), "text/css");
}
